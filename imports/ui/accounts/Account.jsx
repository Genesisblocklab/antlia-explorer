    ...
    render(){
        ...
        if (this.state.loading){
            ...
            <div id="account" style={{
                ...
                <Helmet>
                    <title>Account Details of {this.state.address} on Antlia Explorer | RNS Solutions Pvt Ltd</title>
                    <meta name="description" content={"Account Details of "+this.state.address+" on Antlia"} />
                </Helmet>
                <Row>
