...
export default class Proposals extends Component{
    ...
    render() {
        ...
        <div>
            ...
            <Helmet>
                <title>Proposals on Antlia Explorer | RNS Solutions Pvt Ltd</title>
                <meta name="description" content="Antlia Explorer incorporates on-chain governance. Come to see how on-chain governance can be achieved on Antlia." />
            </Helmet>
            <Row>
